...
/**
 * Constructor of server which starts the whole listening process for receiving information
 */
Server::Server() {
    ...
    netpack->setCommand("Greetings");
    netpack->setData("Welcome to the server");
    const char* message = netpack->getJSONPackage().c_str();
